...
def index(request):
    ...
    most_popular_posts = Post.objects.annotate(likes_count=Count('likes')).select_related('author').order_by('-likes_count')[:5]
    ...
    tags = Tag.objects.annotate(tags_count=Count('title'))
